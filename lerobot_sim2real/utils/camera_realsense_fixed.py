...
try:
    ...
    RS_AVAILABLE = False
    rs = None  # Define rs as None if import fails
...
class RealSenseCamera(Camera):
    ...
    def connect(self, warmup: bool = True):
        ...
        if not RS_AVAILABLE or rs is None:
            raise ImportError("pyrealsense2 is not available. Please install it with: pip install pyrealsense2")
